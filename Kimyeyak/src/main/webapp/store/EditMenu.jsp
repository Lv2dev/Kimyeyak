			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-8">
					...
					<form class="needs-validation" novalidate=""
						action="../store/EditMenuProc"
						method="post" enctype="multipart/form-data">
						<div class="row g-3">
							<!-- 메뉴명 -->
							<div class="col-12">
								<label for="pw" class="form-label">메뉴명</label> <input
									type="text" class="form-control" id="store_name" value="${ menuDTO.menuName }"
							...
							<div class="col-12">
								<label for="pw" class="form-label">가격</label> <input
									type="number" class="form-control" id="store_name" value="${ menuDTO.price }"
									 name="price" required="">
								<div class="invalid-feedback">가게이름을 입력해 주세요</div>
							</div>
							...
							<div class="col-12">
								<label for="nickname" class="form-label">메뉴설명</label> <input
									type="text" class="form-control" id="notice" value="${ menuDTO.notice }"
							...
							<!-- 메뉴설명 -->
							<div class="col-12">
								<label for="nickname" class="form-label">현재 메뉴 이미지</label>
								<c:if test="${ menuDTO.pic == null || menuDTO.pic == '' }">
								<label for="nickname" class="form-label">업로드한 이미지가 없어요</label>
								</c:if>
								<c:if test="${ menuDTO.pic != null }">
								<img src="${ menuDTO.pic }"  class="w-25">
								</c:if>
							</div>
